...
const [lastYearDataMoths, setLastYearDataMonths] = useState({})
      ...
      axios.defaults.headers = {
        ...
        .then(res => {
          ...
          Object.keys(months).map(month => {
            count.push[months[month]]
          })
          setCurrentYearDataMonths();
        })
        .catch(err => {
          console.log(err)
        })
