...
import { Alert, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, Rating, Snackbar, SvgIcon, useMediaQuery } from '@mui/material';
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column' }}>
        <CardContent sx={{ flex: '1 0 auto', mx : '20px' }}>
          ...
          <Typography
            ...
            sx={{ color: 'text.primary',fontSize : 15, my:1 }}
          >
            <svg data-testid="LocalPhoneIcon"> {store.phone}</svg>
