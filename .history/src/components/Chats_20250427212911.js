...
const Chats = (props) => {
    ...
    const auth = useAuth();
    const { pastMessages, activeTab, messages, showMessage, showReplyMessage, chatDivRef, setOpenEmojis, darkMode, handleDarkModeToggle, onChangeAcceptStatus, getInitials, blockReceiver } = props
    ...
    return (
        <Box>
            ...
            >
                ...
                {(accepted === 'P') &&
                    <Accept receiver={receiver} darkMode={darkMode} onChangeStatus={onChangeStatus} getInitials={getInitials} blockReceiver={blockReceiver} />
                }
