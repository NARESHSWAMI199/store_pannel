...
function Page() {
            ...
            .then((res) => {
                ...
                setUserStatus(
                    <div>
                        Last seen at{' '}
                        <ReactTimeAgo
                            date={!!user.lastSeen ? user.lastSeen : new Date}
                            locale="en-US"
                        />
                    </div>
                );
    ...
    useEffect(() => {
        ...
        client.onConnect = (frame) => {
            ...
            client.subscribe(
                `/user/${user?.slug}_${slug}/queue/private`,
                (message) => {
            ...
            <Grid container>
                            ...
                            <Box>
                                ...
                                <Typography sx={{
                                    ...
                                    <div>
                                        Last seen at 
                                        <ReactTimeAgo 
                                            date={!!chatUser.lastSeen ? chatUser.lastSeen : new Date} 
                                            locale="en-US"
                                        />
                                    </div>
                                </Typography>
                ...
                >
                        <Box sx={{
                            ...
                            <Avatar 
                                sx={{ mx: 1 }}
                                src = {`${userImage}${slug}/${reciver?.avatar}`} 
                            />
                            <Typography 
                                variant='subtitle2' 
                                sx={{
